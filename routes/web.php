...
Route::post('/transaksi/public/{token}/bayar', [PosController::class, 'PublicTransaksiBayar'])->name('transaksi.public_bayar');
...
// Moota webhook endpoint moved to API routes (/api/webhook/moota)
